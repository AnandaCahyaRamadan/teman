  ...
  <nav class="nav">
      <div> <a href="" class="nav_link"> <i class='bx bx-qr nav_icon'></i><span class="nav_name">Teman Semarang</span> </a>
          <div class="nav_list">
            ...
            <a href="/admin/pendaftaran" class="nav_link {{ Request::is('admin/pendaftaran*') ? 'active' : '' }}"> <i class='bx bx-list-ul nav_icon'></i> <span class="nav_name">Pendaftaran</span> </a> </div>
      </div> 
